...
void MuTimingModuleWithStat::process(AlgoMuonBase* algoMuon) {
  ...
  LogTrace("l1tMuBayesEventPrint") << __FUNCTION__ << ":" << __LINE__ << " algoMuon SimBeta " << algoMuon->getSimBeta()
  ...
  for (auto& stubResult : algoMuon->getStubResults()) {
    ...
    LogTrace("l1tMuBayesEventPrint") << __FUNCTION__ << ":" << __LINE__ << " layer " << layer << " algoMuon eta "
