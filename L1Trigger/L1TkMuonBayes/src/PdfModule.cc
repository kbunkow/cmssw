...
void PdfModule::processStubs(const MuonStubsInput& muonStubs,
  ...
  int charge =
      -ttTrack
           ->getCharge();  //we inverse the charge since the positive tracks bends into negative phi direction, and we wan to to have positive values of pdfBin when the coeff.at(1) is 0
