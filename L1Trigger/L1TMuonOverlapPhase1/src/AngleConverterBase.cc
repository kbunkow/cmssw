...
int AngleConverterBase::getProcessorPhi(
  ...
  LogTrace("l1tMuBayesEventPrint") << __FUNCTION__ << ":" << 175 << " roll " << rollId << " cluster: firstStrip "
                                   << digi1 << " stripPhi1 " << stripPhi1 << " lastStrip " << digi2 << " stripPhi2 "
                                   << stripPhi2 << " halfStrip " << halfStrip << std::endl;
