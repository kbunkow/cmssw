...
public:
  ...
  virtual const void processInput(unsigned int iProcessor, l1t::tftype mtfType, const OMTFinput& aInput);
  ...
  virtual void setGhostBuster(IGhostBuster* ghostBuster) { this->ghostBuster.reset(ghostBuster); }
