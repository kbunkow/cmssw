...
public:
  ...
  virtual void loadDigis(const edm::Event& event) { event.getByToken(inputTokenCsc, cscDigis); }
...
public:
  ...
  virtual void loadDigis(const edm::Event& event) { event.getByToken(inputTokenRpc, rpcDigis); }
